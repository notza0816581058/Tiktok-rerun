...
const payloads = {
  'live.starting': { accountId: base.accountId, roomId: 'room-1' },
  'live.started': {
    accountId: base.accountId,
    roomId: 'room-1',
    streamStartedAt: '2026-09-25T08:00:00.000Z',
  },
  'live.stopped': { accountId: base.accountId, reason: 'host_ended' },
  'live.error': { accountId: base.accountId, error: { code: 'MOCK_ERROR', message: 'Demo error' } },
  'comment.received': {
    accountId: base.accountId,
    commentId: 'comment-1',
    user: viewer,
