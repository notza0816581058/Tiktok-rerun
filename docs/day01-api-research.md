...
* **Method:** `GET`
* **URL:** `[https://api.tiktok.com/api/live/detail/core/stats](https://api.tiktok.com/api/live/detail/core/stats)`
...
1. **สถานะห้องไลฟ์:** API จะทำงานได้ต่อเมื่อมี `room_id` ที่กำลัง Active เท่านั้น
2. **Rate Limit:** สำหรับ Stats ควรหน่วงเวลาดึงข้อมูล (Polling) ทุกๆ 5-10 วินาที
3. **การจัดการ Session:** ต้องมีระบบแจ้งเตือนเมื่อ Cookie หมดอายุเพื่อให้ผู้ใช้อัปเดตได้ทันที
